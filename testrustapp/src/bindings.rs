...
pub mod component {
    pub mod testapp {
        ...
        pub mod custom_host {
            ...
            pub type Row = _rt::Vec<Value>;
            pub type Rows = _rt::Vec<Row>;
            #[allow(unused_unsafe, clippy::all)]
            pub fn query(query: &str, args: &[Value]) -> Option<Rows> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
                    ...
                    #[link(wasm_import_module = "component:testapp/custom-host")]
                    unsafe extern "C" {
                        #[link_name = "query"]
                        fn wit_import5(
                            _: *mut u8,
                            ...
                            let e = {
                                ...
                                for i in 0..len22 {
                                    ...
                                    let e22 = {
                                        ...
                                        _rt::cabi_dealloc(
                                            base21,
                                            len21 * (8 + 2 * ::core::mem::size_of::<*const u8>()),
                                            8,
                                        );
                                        result21
                                    };
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:component:testapp:example:encoded world"
)]
#[doc(hidden)]
...
\x18\x03\0\x15wasi:io/streams@0.2.3\x05\x04\x02\x03\0\x02\x0cinput-stream\x01B\x05\
\x02\x03\x02\x01\x05\x04\0\x0cinput-stream\x03\0\0\x01i\x01\x01@\0\0\x02\x04\0\x09\
get-stdin\x01\x03\x03\0\x14wasi:cli/stdin@0.2.3\x05\x06\x02\x03\0\x02\x0doutput-\
stream\x01B\x05\x02\x03\x02\x01\x07\x04\0\x0doutput-stream\x03\0\0\x01i\x01\x01@\
\0\0\x02\x04\0\x0aget-stdout\x01\x03\x03\0\x15wasi:cli/stdout@0.2.3\x05\x08\x01B\
\x05\x02\x03\x02\x01\x07\x04\0\x0doutput-stream\x03\0\0\x01i\x01\x01@\0\0\x02\x04\
\0\x0aget-stderr\x01\x03\x03\0\x15wasi:cli/stderr@0.2.3\x05\x09\x01B\x0d\x01p}\x01\
q\x05\x04null\0\0\x03int\x01x\0\x04real\x01u\0\x04text\x01s\0\x04blob\x01\0\0\x04\
\0\x05value\x03\0\x01\x01p\x02\x04\0\x03row\x03\0\x03\x01p\x04\x04\0\x04rows\x03\
\0\x05\x01p\x02\x01k\x06\x01@\x02\x05querys\x04args\x07\0\x08\x04\0\x05query\x01\
\x09\x01@\0\0s\x04\0\x03huh\x01\x0a\x03\0\x1dcomponent:testapp/custom-host\x05\x0a\
\x01@\0\0s\x04\0\x0bhello-world\x01\x0b\x04\0\x19component:testapp/example\x04\0\
